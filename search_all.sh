...
python calc_bounds.py -m models/best_ECFP_SMILES/epoch_300.pt
python calc_bounds.py -m models/best_KRFP_SMILES/epoch_300.pt
python calc_bounds.py -m models/best_ECFP_DeepSMILES/epoch_300.pt
python calc_bounds.py -m models/best_KRFP_DeepSMILES/epoch_300.pt
